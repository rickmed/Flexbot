...
exports.msg = {
  // centrifuga: 'Codigo Centrifuga found:',
  ...
  // flxBotErr: 'flexBot threw an error',
  // generalErr: 'Hubo un error desconocido',
  // quitGood: 'Done updating all publications prices. Quiting...'
